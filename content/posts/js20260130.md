+++
title = "一行命令获取  windows linux 电脑服务器硬件信息"
...
查看电脑详细的硬件配置和参数，一般都需要安装专门的硬件检测软件，总感觉不太方便，笔者就 Vibe Coding 了两份可以分别查看 Windows 和 Linux 电脑硬件信息的脚本，并且把脚本部署到云上VPS，现在可以不需要安装专门的检测软件了，直接在命令行窗口运行一条简单的命令，就可以查看到自己电脑的硬件信息了，包括主板、CPU、内存、硬盘、显卡等等硬件的型号、基本参数，序列号等多项信息，非常直观方便。

这个获取硬件信息的脚本运行起来也非常简单，前提是你的电脑能上网，下面说说它的使用方法：

### 一行命令获取Windows系统电脑的硬件配置

Windows系统的电脑，支持 Windows 10/11/Server 等版本，这里以Windows 10 来演示：

1.  右键点击“开始”菜单，点击 “Powershell” 选项，打开Powershell 命令行窗口  
    ![26896c1b9395b41c357e070000d15b51.png](/img/26896c1b9395b41c357e070000d15b51.png)

- 或者按下 Win+R 快捷键打开“运行”窗口，输入"powershell" 再点击“确定”，也可以打开powershell 命令行窗口  
    ![4b399b69d65f25d1bd74583005c7ea3d.png](/img/4b399b69d65f25d1bd74583005c7ea3d.png)

2.  在 Powershell 窗口中输入如下这条命令并按回车键执行它：
```
irm http://win.freezz.cn | iex
```
![1b6c2dc53d337328b83077acdc3360d4.png](/img/1b6c2dc53d337328b83077acdc3360d4.png)

3.  执行命令后，稍等几秒钟，就可以看到电脑所有的硬件配置信息了  
    ![568b14df029336cae2040c8c086c99cd.png](/img/568b14df029336cae2040c8c086c99cd.png)


### 一行命令获取Linux系统电脑的硬件配置

如果是Linux系统的电脑，比如 Red Hat / Centos / Debian / Ubuntu / 银河麒麟Kylin / 欧拉openEuler 等，  
打开命令行终端Shell，执行这行命令：
...
![a573bc4b9a2d946b0613160d2f3a3c3a.png](/img/a573bc4b9a2d946b0613160d2f3a3c3a.png)

![df8c043f3ad378d38586ae88440002d3.png](/img/df8c043f3ad378d38586ae88440002d3.png)

下面是脚本的源码

### 获取windows电脑硬件配置信息的脚本源码
```
